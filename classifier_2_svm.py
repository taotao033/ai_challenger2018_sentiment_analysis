...
if __name__ == '__main__':
    ...
    data_dict = get_train_data_2(path="./dataset/data_reform/train_reform_content_after_cut.csv")
    for key in data_dict.keys():
        ...
        train_features_save_path = "./classifier_2_train_features_svm_format_files/" + column_list[column_list.index(key)]
    ...
    for column in column_list:
        model_save_path = "./model_files_classifier_2/" + column
        if not os.path.exists(model_save_path):
            os.makedirs(model_save_path)
        subprocess.call("./thundersvm-master/build/bin/thundersvm-train -c 100 -g 0.5 " +
                        "./classifier_2_train_features_svm_format_files/" + column + "/" + column + ".txt "
    ...
    subprocess.call("python classifier_3_svm.py", shell=True)
